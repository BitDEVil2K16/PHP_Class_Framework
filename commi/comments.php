...
$DATABASE_USER = 'CommentSystem';
$DATABASE_PASS = '46t42AGEdA';
$DATABASE_NAME = 'CommentSystem';
try {
...
function time_elapsed_string($datetime, $full = false) {
    ...
    $diff->d -= $diff->w * 7;
    $string = array('y' => 'jahre', 'm' => 'monate', 'w' => 'woche', 'd' => 'tage', 'h' => 'stunde', 'i' => 'minute', 's' => 'sekunde');
    ...
    return $string ? 'vor '.implode(', ', $string) . '' : 'jetzt grade';
}
    ...
    foreach ($comments as $comment) {
        if ($comment['parent_id'] == $parent_id) {
            ...
            <div class="comment">
                ...
                <a class="reply_comment_btn" href="#" data-comment-id="' . $comment['id'] . '">Antworten</a>
...
function show_write_comment_form($parent_id = -1) {
    ...
    <div class="write_comment" data-comment-id="' . $parent_id . '">
        <form>
            ...
            <input name="name" type="hidden" value="PHPName" required>
...
if (isset($_GET['page_id'])) {
    ...
    if (isset($_POST['name'], $_POST['content'])) {
        ...
        exit('Dein Kommentar wurde übermittelt!');
    }
...
<div class="comment_header">
    <span class="total"><?=$comments_info['total_comments']?> Kommentare</span>
    <a href="#" class="write_comment_btn" data-comment-id="-1">Kommentar schreiben</a>
</div>
